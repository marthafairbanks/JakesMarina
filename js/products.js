  	...
  	success: function (results) {
		...
		marina.forEach(function(marinaInfo){
 		...
 		var boatDescription = marinaInfo.description;
  		...
  		$('.boatRow').append('<div class="col-lg-6 boatInfo"><img class="productBoatImg" src="'+boatPic+'" />\
						<div class="boatPrice">'+boatPrice+'</div><div class="boatName">'+boatName+'</div>\
						<div class="boatDescrip">'+boatDescription+'</div></div></div>');
		});
